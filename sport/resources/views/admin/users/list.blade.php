	...
	<div class="content">
      ...
      <h2 class="text-bold text-body-emphasis mb-3">User List</h2>
      <ul class="nav nav-links mb-3 mb-lg-2 mx-n3">
        ...
        <li class="nav-item"><a class="nav-link" href="#"><span>Active </span><span class="text-body-tertiary fw-semibold">({{ $activeCount }})</span></a></li>
        <li class="nav-item"><a class="nav-link" href="#"><span>Blocked </span><span class="text-body-tertiary fw-semibold">({{ $blockedCount  }})</span></a></li>
      </ul>
      <div id="members"
              ...
              <div class="d-flex flex-wrap gap-3">
                <div class="search-box">
                  <form class="position-relative">
                    <input class="form-control search-input search" type="search" placeholder="Search user" aria-label="Search" />
               ...
               <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{ route('admin.register') }}" class="btn btn-subtle-secondary me-1 mb-1" id="addBtn">
        ...
        <div class="mb-9 bg-body-emphasis border mt-2 position-relative top-1">
          <div class="table-responsive scrollbar ms-n1 ps-1">
            <table class="table table-sm fs-9 mb-0">
              <thead>
                <tr>
                  <th class="sort align-middle" scope="col" data-sort="customer" style="width:15%; min-width:200px;">User Name</th>
                  <th class="sort align-middle" scope="col" data-sort="email" style="width:15%; min-width:200px;">Email</th>
                  <th class="sort align-middle pe-3" scope="col" data-sort="mobile_number" style="width:20%; min-width:200px;">Role</th>
              ...
              <tbody class="list" id="members-table-body">
               @foreach($admins as $admin)
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        ...
                        <!-- Email -->
                        <td class="email align-middle white-space-nowrap">
                            <a class="fw-semibold" href="mailto:{{ $admin->email }}">{{ $admin->email }}</a>
                        </td>

                        <!-- Role (show first role only if multiple) -->
                        <td class="mobile_number align-middle white-space-nowrap">
                            @if($admin->roles->isNotEmpty())
                                <span class="fw-bold text-body-emphasis">{{ $admin->roles->first()->name }}</span>
                            @else
                        ...
                        <td class="joined align-middle white-space-nowrap text-body-tertiary text-center">
                            <div class="btn-reveal-trigger position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end py-2">
                                    <a class="dropdown-item" href="{{ route('admin.user.edit', $admin->id) }}">Edit</a>

                                    @if(!$admin->roles->contains('slug', 'super-admin'))
                                        <div class="dropdown-divider"></div>
                                        <form action="{{ route('admin.user.remove', $admin->id) }}" method="POST" class="d-inline" 
